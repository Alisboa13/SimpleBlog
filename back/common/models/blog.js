...
module.exports = function(Blog) {
  ...
  Blog.validatesLenghtOf('title', {min: 3, max: 255, message: {min: "Title too short", max: "Title too long"}});
  Blog.validatesLenghtOf('content', {min: 3, message: {min: "content too short"}});
